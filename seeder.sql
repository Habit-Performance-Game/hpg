...
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (7, 'ra ra-brandy-bottle ra-2x blue', 'Drink 8oz of water.', 8, 'ind', 1);
...
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (9, 'ra ra-book ra-2x green', 'Read for 30mins', 30, 'ind', 3);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (10, 'ra ra-daisy ra-2x green', 'Meditation', 30, 'ind', 4);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (11, 'ra ra-knife-fork ra-2x green', 'Meals without Sugar', 10, 'ind', 1);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (12, 'ra ra-double-team ra-2x green', 'Volunteer 20 hours.', 20, 'ind', 5);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (13, 'ra ra-quill-ink ra-2x red', 'One hour of code for 100 days.', 100, 'ind', 3);
...
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (19, 'ra ra-double-team ra-2x silver', 'Volunteer 100 hours.', 100, 'clan', 5);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (20, 'ra ra-double-team ra-2x gold', 'Volunteer 200 hours.', 200, 'clan', 5);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (21, 'ra ra-brandy-bottle ra-2x silver', 'Drink 800oz of water.', 800, 'clan', 1);
INSERT INTO hpg_db.badges (id, icon_classes, name, req_amt, type, category_id) VALUES (22, 'ra ra-brandy-bottle ra-2x gold', 'Drink 1600oz of water.', 1600, 'clan', 1);
